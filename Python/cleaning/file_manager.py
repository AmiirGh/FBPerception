...
s2t = pd.read_csv('Speech recognition validation.csv')
if __name__ == "__main__":
    ...
    # update_demographics_values(recording_directory)
    # update_setup_participant_ids()
    # update_demographics_values(recording_directory)

    calculate_speech_recognition_stats(s2t)
