...
def exp_performance_full():
    ...
    window_1 = [0, 1]
    window_2 = [2, 3]
    no_collision_window_1 = calc_no_collisions_by_fbmod_for_time_window(subjects_data_full, subjects_data_trials, start_sec=window_1[0], end_sec=window_1[1])
    no_collision_window_2 = calc_no_collisions_by_fbmod_for_time_window(subjects_data_full, subjects_data_trials, start_sec=window_2[0], end_sec=window_2[1])
    plot_collision_time_windows(no_collision_window_1, no_collision_window_2, window_1, window_2)
    compare_time_windows_significance(no_collision_window_1, no_collision_window_2)
...
def exp_performance_trials():
    ...
    visual_miss_outliers = ['Samar_1783', 'Yas_4358']
